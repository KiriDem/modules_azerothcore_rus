...
const std::unordered_map<LocaleConstant, std::string> AB_WELCOME_TO_PLAYER = {
    ...
    {LOCALE_ruRU, "|cffc3dbff [AutoBalance]|r|cffFF8000 Добро пожаловать в {} ({} игрок {}). В этом подземелье {} игроков. Сложность установлена на {} игроков.|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_ANNOUNCE_NON_GM_ENTERING_INSTANCE = {
    ...
    {LOCALE_ruRU, "|cffc3dbff [AutoBalance]|r|cffFF8000 {} входит в подземелье. В этом подземелье {} игроков. Сложность установлена на {} игроков.|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_LEAVING_INSTANCE_COMBAT = {
	...
	{LOCALE_ruRU, "|cffc3dbff [AutoBalance]|r|cffFF8000 {} покинул игру во время боя. Сложность заблокирована для игроков в количестве не менее {} до окончания боя.|r"},
...
const std::unordered_map<LocaleConstant, std::string> AB_LEAVING_INSTANCE = {
	...
	{LOCALE_ruRU, "|cffc3dbff [AutoBalance]|r|cffFF8000 {} покинул подземелье. В этом подземелье есть {} игроков. Уровень сложности равен {} игрокам.|r"},
...
const std::unordered_map<LocaleConstant, std::string> AB_SET_OFFSET_COMMAND_DESCRIPTION = {
    ...
    {LOCALE_ruRU, "Устанавливает смещение сложности игрока для этого подземелья. Используйте: .ab offset <число>.|r"}
};
...
const std::unordered_map<LocaleConstant, std::string> AB_ADJUSTED_PLAYER_COUNT_MAP_MINIMUM = {
    ...
    {LOCALE_ruRU, "Скорректированное количество игроков: {} (минимальное для карты)|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_ADJUSTED_PLAYER_COUNT_MAP_MINIMUM_DIFFICULTY_OFFSET = {
    ...
    {LOCALE_ruRU, "Скорректированное количество игроков: {} (Минимум карты + Смещение сложности {})|r"}
};
...
const std::unordered_map<LocaleConstant, std::string> AB_ADJUSTED_PLAYER_COUNT = {
    ...
    {LOCALE_ruRU, "Скорректированное количество игроков: {}|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_WORLD_HEALTH_MULTIPLIER = {
    ...
    {LOCALE_ruRU, "Глобальный множитель здоровья: {:.3f}|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_WORLD_HOSTILE_DAMAGE_HEALING_MULTIPLIER_TO = {
    ...
    {LOCALE_ruRU, "Глобальный множитель урона и лечения: {:.3f} -> {:.3f}|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_WORLD_HOSTILE_DAMAGE_HEALING_MULTIPLIER = {
    ...
    {LOCALE_ruRU, "Глобальный множитель урона и лечения: {:.3f}|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_ACTIVE_TOTAL_CREATURES_IN_MAP = {
    ...
    {LOCALE_ruRU, "Активно | Всего существ на карте: {} | {}|r"},
};
