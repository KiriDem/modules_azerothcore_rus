...
public:
    ...
    void OnPlayerEnterAll(Map* map, Player* player) override
    {
        ...
        ChatHandler(player->GetSession()).SendSysMessage(
            "|cFF00FF00[Dungeon Master]|r Подготовка задания...");
        ...
        snprintf(buf, sizeof(buf),
            "|cFF00FF00[Dungeon Master]|r Появилось |cFFFFFFFF%u|r врагов и |cFFFFFFFF%u|r боссов. "
            "Уровни существ: |cFFFFFFFF%u-%u|r. Удачи!",
            session->TotalMobs, session->TotalBosses,
