...
(@MODULE_STRING, 1, 'ruRU', 'Этот сервер использует модуль |cff4CFF00Loot aoe|r.'),
(@MODULE_STRING, 2, 'ruRU', '|cff4CFF00[Loot aoe]|r Ваши предметы отправленны в инвентарь.'),
(@MODULE_STRING, 3, 'ruRU', 'Модуль AOE Loot активен. Используйте .aoeloot on/off для переключения состояния.'),
(@MODULE_STRING, 4, 'ruRU', 'AOE Loot: Предметы задания отправленны в ваш инвентарь.'),
(@MODULE_STRING, 5, 'ruRU', 'AOE Loot уже включен для вашего персонажа'),
(@MODULE_STRING, 6, 'ruRU', 'AOE Loot уже включен для вашего персонажа. Введите .aoeloot off для выключения.'),
(@MODULE_STRING, 7, 'ruRU', 'AOE Loot уже выключен для вашего персонажа.'),
(@MODULE_STRING, 8, 'ruRU', 'AOE Loot уже выключен для вашего персонажа. Введите .aoeloot on для включения.');
