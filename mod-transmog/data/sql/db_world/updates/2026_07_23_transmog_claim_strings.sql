...
('transmog claim', 0, 'Syntax:\n.transmog claim [item link]\n.transmog claim <bag> <slot>\n.transmog claim all\nПозволяет добавить в коллекцию внешний вид предмета, находящегося в сумке (без его экипировки и привязки к персонажу). Укажите ссылку на предмет (полученную с помощью Shift + клик), номер сумки и ячейки (сумка 0 — основной рюкзак, 1–4 — дополнительные сумки; нумерация ячеек начинается с 1) либо введите «all», чтобы добавить в коллекцию все новые варианты внешнего вида из ваших сумок.');
