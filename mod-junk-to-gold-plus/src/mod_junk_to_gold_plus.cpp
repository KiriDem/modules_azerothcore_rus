...
namespace
{
    static char const* const ITEM_LINK_MULTIPLE = "|cff9d9d9d|Hпредмет:{}::::::::{}:::::|h[{}]|h|rx{}";
    static char const* const ITEM_LINK_SINGLE = "|cff9d9d9d|Hпредмет:{}::::::::{}:::::|h[{}]|h|r";

    static char const* const SOLD_FOR_COPPER = "{} продан за {} медяков.";
    static char const* const SOLD_FOR_SILVER_COPPER = "{} продан за {} серебряных и {} медяков.";
    static char const* const SOLD_FOR_SILVER = "{} продан за {} серебряных.";
    static char const* const SOLD_FOR_GOLD_SILVER_COPPER = "{} продан за {} золотых, {} серебряных и {} медяков.";
    static char const* const SOLD_FOR_GOLD_COPPER = "{} продан за {} золотых и {} медяков.";
    static char const* const SOLD_FOR_GOLD_SILVER = "{} продан за {} золотых и {} серебряных.";
    static char const* const SOLD_FOR_GOLD = "{} продан за {} золотых.";
}
