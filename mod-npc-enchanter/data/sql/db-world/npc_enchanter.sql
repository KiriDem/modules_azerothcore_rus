...
INSERT INTO `npc_text` (`ID`, `text0_0`) VALUES (@Entry, 'Приветствую $N. Борегар Костеблеск к вашим услугам. Я предлагаю широкий выбор чар для снаряжения начинающим искателям приключений.');
